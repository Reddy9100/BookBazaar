...
const Orders = () => {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-custom-dark min-h-screen">
      <Link to="/orders">
        <div className='flex border border-white w-full justify-between items-center mb-6 p-4 rounded-lg shadow-lg bg-custom-dark'>
          <h2 className="text-2xl font-bold text-center text-spotify-accent">Your Orders</h2>
          <Lottie animationData={ordersLottie} className='h-[60px]' />
        </div>
      </Link>
