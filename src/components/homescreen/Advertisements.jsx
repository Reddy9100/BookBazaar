...
const Advertisements = () => {
  return (
    <div className="flex  bg-black justify-around p-2">
      {/* Vertical text div */}
      <div className="flex items-center justify-center h-[182px] bg-gray-800 text-white">
      ...
      {/* Carousel div */}
      <div className="w-[80vw] h-[182px]">
        <Carousel autoplay className="h-[182px]">
          <div className="h-[182px]">
            <img
              ...
              alt="Ad 1"
              className="w-full h-[182px] object-fill"
            />
          </div>
          <div className="h-[182px]">
            <img
